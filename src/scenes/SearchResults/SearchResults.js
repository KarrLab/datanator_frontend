...
class SearchResults extends Component {
  ...
  componentDidUpdate(prevProps) {
    const values = queryString.parse(this.props.location.search);
    const old_values = queryString.parse(prevProps.location.search);
  ...
  fetch_data(indices, size){
    ...
    let url = "";
    if (indices === "protein"){
      url = "ftx/text_search/protein_ranked_by_ko/"
        + "?query_message=" + values.q 
        + "&from_=" + from_ 
        + "&size=" + size 
      ...
      <div>
        ...
        <div className="content-container content-container-columns">
          <div className="content-block table-of-contents">
            ...
            <ul className="content-block-content">
              <li>
                <HashLink to="#metabolites" scroll={scrollTo}>{"Metabolites"}</HashLink>
              </li>
              <li>
                <HashLink to="#proteins" scroll={scrollTo}>{"Proteins"}</HashLink>
              </li>
              <li>
                <HashLink to="#reactions" scroll={scrollTo}>{"Reactions"}</HashLink>
              </li>
            </ul>
          </div>
