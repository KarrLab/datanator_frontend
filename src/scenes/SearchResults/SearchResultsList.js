...
export default class SearchResultsList extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (
      ...
      this.props.metabolite_results != null
    ) {
      this.add_metabolites();
    }
    ...
    if (
      ...
      this.props.protein_results != null
    ) {
      this.add_proteins();
    }

    if (
      this.props.reaction_results !== prevProps.reaction_results &&
      this.props.reaction_results != null
    ) {
      this.add_reactions();
    }
  }
