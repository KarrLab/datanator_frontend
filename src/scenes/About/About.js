      ...
      <div className="content-container content-container-about-scene">
        ...
        <div className="content-container-columns">
          ...
          <div className="content-column">
              ...
              <div className="content-block section">
                ...
                <div className="content-block-content">
                  <p>
                    ...
                    different identifiers, units, and formats. In addition,
                    there are few tools for finding data that is relevant to
                    modeling a specific cell in a specific environment. These
                    barriers impede mechanistic modeling.
                  </p>
                  <p>
                    To accelerate cell modeling, <i>Datanator</i> provides
                    researchers tools for systematically discovering the data
                    needed to model specific biochemical mechanisms in a
                    specific cell in a specific environment. <i>Datanator</i>{" "}
                    includes an integrated database of genomic and biochemical
                    data about several aspects of cells, this web application
                    for searching the database for data relevant to specific
                    cells and environments, and a REST API and Python library
                    for programmatically aggregating data for large models. The
                    web application enables investigators to search for
                    experimental measurements of biochemical parameters (e.g.
                    metabolite concentration, reaction rate, etc.) relevant to a
                    specific cell (taxon, cell type) in a specific environment
                    (e.g., temperature, pH, growth media, etc.). For each
                    search, this web application displays a filterable and
                    sortable list of relevant experimental measurements
                    aggregated from a range of sources.
                  </p>
                </div>
              </div>
            </ScrollableAnchor>
              ...
              <div className="content-block section search-filtering">
                ...
                <div className="content-block-content">
                  ...
                  <ul className="no-top-margin">
                    ...
                    <li>
                      <b>Molecular similarity:</b> Users can identify
                      measurements of similar metabolites according to the{" "}
                      <a
                        href={
                    ...
                    <li>
                      ...
                      measurements observed in closely related taxa to their
                      taxon of interest by filtering measurements according to
                      their distance along the{" "}
                      <a
                        href={
            ...
            <ScrollableAnchor id="code">
              <div className="content-block section">
                <h2 className="content-block-heading">Source code</h2>

                <div className="content-block-content">
                  <p className="no-bottom-margin">
                    The <i>Datanator</i> source code is composed of the
                    following packages. Each package is available from GitHub.
                  </p>
                  <ul className="no-top-margin">
                    <li>
                      <a
                    ...
                    <li>
                      <a
                        href={
                          "https://github.com/KarrLab/datanator_query_python"
                        }
                        target="_blank"
                        rel="noopener noreferrer"
                      >
            ...
            <ScrollableAnchor id="tech">
              <div className="content-block section tech">
                <h2 className="content-block-heading">
            ...
            <ScrollableAnchor id="contribute">
              <div className="content-block section developers">
                ...
                <div className="content-block-content">
                  ...
                  datasets. Please contact the developers to coordinate
                  potential contributions, and please see the{" "}
                  <a
                    href="https://github.com/KarrLab/datanator_frontend/blob/master/README.md"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              <div className="content-block section funding">
                ...
                <div className="content-block-content">
                  <p>
                    ...
                    and the National Institute of General Medical Sciences of
