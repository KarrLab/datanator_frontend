      ...
      <ScrollableAnchor id={"faq"}>
        <div className="content-block section">
          ...
          <div className="content-block-content">
            <div className="faq">
              ...
              <div className="faq-a">
                ...
                <p>
                  ...
                  than UniProt ids because each UniProt id only refers to a
                  single gene in a single organism.
                </p>
              </div>
            </div>
            ...
            <div className="faq">
              <div className="faq-q">
                Why does the metabolite concentration data table display data
                for biomolecules that were not queried (e.g., ADP is displayed
                in the page for ATP)?
              </div>
              <div className="faq-a">
                <p>
                ...
                <p>
                  ...
                  &quot;Chemical similarity&quot; filter can be used to narrow
                  the displayed measurements to measurements of highly similar
            ...
            <div className="faq">
              ...
              <div className="faq-a">
                <p>
                  ...
                  reported by the original authors and the primary databases
                  that <i>Datanator</i> integrates.
                </p>

                <p>
                  All of <i>Datanator</i>&apos;s data tables provide information
                  about the organism in which each measurement was conducted.
                  This information can be filtered to find data measured in
                  closely related organisms.
                </p>

                <p>
                  In addition, the measurements in the protein abundance table
                  can be filtered by tissue type, and the measurements in the
                  reaction rate constants table can be filtered by whether the
                  measurement was conducted in a wildtype or mutant strain.
                </p>
              </div>
            </div>
            ...
            <div className="faq">
              ...
              <div className="faq-a">
                <p>
                  ...
                  condition. Note, this is limited by the metadata reported by
                  the original authors and the primary databases that{" "}
              ...
              <div className="faq-a">
                <ul className="vertically-spaced">
                  <li>
                    ...
                    biochemical data to identify the <b>initial conditions</b>{" "}
                    and <b>rate parameters</b> of{" "}
                  ...
                  <li>
                    ...
                    conduct multi-dimensional analyses of an individual organism
                    or conduct comparative analyses of multiple organisms.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="faq">
              ...
              <div className="faq-a">
                ...
                <ul className="vertically-spaced">
                  <li>
                    <i>Datanator</i> can help modelers <b>design</b> the scope
                    and granularity of a model by helping modelers assess the
            ...
            <div className="faq">
              ...
              <div className="faq-a">
                Please <a href="#contact">contact us</a> to discuss how to
                integrate your data into <i>Datanator</i>. We are particularly
                interested in molecular data about metabolites, DNA, RNA,
                proteins, complexes, and reactions such as RNA abundance,
                protein half-lives, and RNA and protein modification and
                localization.
              </div>
            </div>
            ...
            <div className="faq">
              ...
              <div className="faq-a">
                We would love to work together to integrate data for
                biomodeling. Please <a href="#contact">contact us</a> to discuss
                how to get involved.
              </div>
            </div>
          </div>
