          ...
          <div className="content-block-content">
            <div className="tutorial">
              <div className="tutorial-overview">
                ...
                tutorial, we demonstrate how <i>Datanator</i> can help
                researchers find data for modeling ATP in{" "}
                <i>Bacillus subtilis subsp. subtilis</i>. The steps illustrated
                below can be used to find data to model any molecule in any
                other organism in any environment.
              </div>
              <ol className="tutorial-steps">
                <li className="tutorial-step">
                  <div className="tutorial-step-title">
                    ...
                    Type <q>ATP</q> in the first input box below the logo and
                    type <q>Bacillus subtilis subs. subtilis</q> in the second
                    input box. Then press <q>Enter</q> to execute the search.
                  </div>
                  ...
                  <div className="tutorial-step-text">
                    Alternatively, you can search the <i>Datanator</i> database
                ...
                <li className="tutorial-step">
                  ...
                  <div className="tutorial-step-text">
                    ...
                    <i>Datanator</i> has aggregated about ATP. This will take
                ...
                <li className="tutorial-step">
                  ...
                  <div className="tutorial-step-text">
                    ...
                    experimental observation of the concentration of ATP or a
                    similar metabolite. The <q>Organism</q> column indicates the
                    organism in which the concentration was measured. The{" "}
                    <q>Source</q> column contains links to the resources from
                ...
                <li className="tutorial-step">
                  ...
                  <div className="tutorial-step-text">
                    ...
                    concentration table to open controls for displaying and
                    hiding columns. For example, click the checkbox next to{" "}
                    <q>Media</q> to display an additional column with
                ...
                <li className="tutorial-step">
                  ...
                  <div className="tutorial-step-text">
                    <p>
                      ...
                      every metabolite in every organism in every environment,{" "}
                      ...
                      their chemical similarity to ATP and taxonomic similarity
                      to <i>Bacillus subtilis subsp. subtilis</i>.{" "}
                      <i>Datanator</i> also provides filters to find data
                      measured under specific environmental conditions (e.g.,
                      temperature, pH, growth media). Below, we illustrate three
                      of these filters.
                    </p>
                    <ul className="vertically-spaced">
                      <li>
                        ...
                        open the <q>Chemical similarity</q> sub-tab. Next, use
                        the slider to filter for concentrations measured for
                        highly similar molecules. <i>Datanator</i> uses the{" "}
                        <a
                          href={
                        ...
                        to determine the similarity between the structures of
                        two metabolites. A score of 1 corresponds to two
                        identical structures.
                      </li>
                      <li>
                        <b>Taxonomic similarity:</b> Open the{" "}
                        <q>Taxonomic similarity</q> sub-tab and use the slider
                        to filter for concentrations observed in similar
                        organisms. By default, <i>Datanator</i> displays data
                        observed in any organism. The slider can be used to find
                        data only observed in{" "}
                        <i>Bacillus subtilis subsp. subtilis</i>.
                      </li>
                      <li>
                ...
                <li className="tutorial-step">
                  ...
                  <div className="tutorial-step-text">
                    ...
                    distribution of the measurements listed in the table. Next,
                    use the checkboxes in the table to select specific
